...
```
<div style="text-align:justify">
Below is a printed summary of the information displayed above in the box plot.  
</div>
<br>
```{r echo=FALSE}
...
<br>
<div style="text-align:justify">
Does the printed information match up with what is displayed in the box plot?  What does it say about the data if the box were to be shorter?  Taller?  Are there any outliers in the data?
</div>
<br>
```{r echo=FALSE}
getdata <- getNWCData(huc="101900030304")
