---
title: 'Lab 1: Becoming Familiar with the Water Budget Tool
  from the NWC-DP'
output:
  html_document:
    depth: 2
...
<script>
  ...
  function togglecode(id,senderid) {
    ...
    if(e.style.display == 'block') {
      ...
      e2.innerHTML='Show Answer';
    } else {
      e.style.display = 'block';
      e2.innerHTML='Hide Answer';
    }
  }
...
![**Figure 5: A 12 Digit HUC layer displayed over Madison, Wisconsin.**](https://raw.githubusercontent.com/dblodgett-usgs/NWCEd/master/inst/Lab1_NWC-DP_Images/Figure5Nashville12Digit.JPG)
...
![**Figure 6-a: A monthly time series plot of precipitation and evapotranspiration.**](https://raw.githubusercontent.com/dblodgett-usgs/NWCEd/master/inst/Lab1_NWC-DP_Images/Figure6NashvilleTimeSeriesa.JPG)
...
![**Figure 7-a: A monthly time series plot of precipitation,evapotranspiration, and streamflow datasets.**](https://raw.githubusercontent.com/dblodgett-usgs/NWCEd/master/inst/Lab1_NWC-DP_Images/Figure6NashvilleWaterBudgetb.JPG)

<br>

<div style= "width: 500px; height= 300px;PADDING-RIGHT: 5px; float: left">![**Figure 7-b: HUC information for water budget.**](https://raw.githubusercontent.com/dblodgett-usgs/NWCEd/master/inst/Lab1_NWC-DP_Images/Figure6NashvilleWaterBudgetc.jpeg)
</div> 
...
<div style="text-align:left">
  <a id="codetoggle1" onclick="togglecode('graphcode1','codetoggle1');">Show Answer</a>
</div>
<div style="text-align:justify; clear: left">
<code id="graphcode1">
...
<div style="text-align:left">
  <a id="codetoggle2" onclick="togglecode('graphcode2','codetoggle2');">Show Answer</a>
</div>
<div style="text-align:justify; clear: left">
<code id="graphcode2">
130302020203
...
<div style="text-align:left">
  <a id="codetoggle3" onclick="togglecode('graphcode3','codetoggle3');">Show Answer</a>
</div>
<div style="text-align:justify; clear: left">
<code id="graphcode3">
...
<div style="text-align:left">
  <a id="codetoggle4" onclick="togglecode('graphcode4','codetoggle4');">Show Answer</a>
</div>
<div style="text-align:justify; clear: left">
<code id="graphcode4">
mm/month
