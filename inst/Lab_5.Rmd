...
```{r get NWC-DP dataset, eval=TRUE, echo=TRUE}
...
```{r Log Pearson Type III function, echo=TRUE}
library(iterators)
library(foreach)
library(ggplot2)
library(NWCEd)
