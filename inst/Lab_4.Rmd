...
xl_data<-download.file("https://cdn.rawgit.com/dblodgett-usgs/NWCEd/master/inst/extdata/doublemassplot2.xlsx", quiet = TRUE, destfile = './doublemassplot2.xlsx')
NWCdataprcpsumannual4<-read.xlsx('./doublemassplot2.xlsx', sheetName = "Sheet1")
...
NWCdataprcpsumannual4<-read.xlsx('./doublemassplot2.xlsx', sheetName = "Sheet2")
...
NWcdataprcpsumannualcum3<-cumsum(NWCdataprcpsumannual3$data)
NWCdataprcpsumannual4<-read.xlsx('./doublemassplot2.xlsx', sheetName = "Sheet2")
file.remove('./doublemassplot2.xlsx')
NWcdataprcpsumannualcum4<-cumsum(NWCdataprcpsumannual4$data)
annualaverage <- (NWCdataprcpsumannual1$data + NWCdataprcpsumannual2$data + NWCdataprcpsumannual3$data + NWCdataprcpsumannual4$data)/4
annualaveragecum<-cumsum(annualaverage)
plot4<-data.frame(x = annualaveragecum, y = NWcdataprcpsumannualcum4)
...
correcteddata<- read.xlsx('./doublemassplot2.xlsx', sheetName = "Sheet2")

uncorrecteddata<- read.xlsx('./doublemassplot2.xlsx', sheetName = "Sheet1")
