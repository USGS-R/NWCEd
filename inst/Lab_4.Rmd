...
```
<br>
As you can clearly see, not correcting the data would result in values that are substantially higher than expected.  What water management problems can you think of if you used the uncorrected data in your planning?
