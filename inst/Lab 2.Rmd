...
![**Figure 1: Streamflow Statistics Calculator homepage.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure1StreamflowStatsHomepage.JPG", package = "NWCEd"))` )
...
![**Figure 2: Gage layer selections.** ]( `r I(system.file("Lab2_NWC-DP_Images/Figure4StreamflowGageFilter.JPG", package = "NWCEd"))` )
...
![**Figure 3: Gages-II abstract and metadata link.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure3MetaDataLink.JPG", package = "NWCEd"))` ) 
</div><div style= "width: 425px; height= 300px; float: right">
![**Figure 4: Webpage displaying metadata.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure2MetaDataHomePage.JPG", package = "NWCEd"))` ) 
</div>
...
![**Figure 5: La Pine gage location. link.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure5LaPineArrow.JPG", package = "NWCEd"))` ) 
</div><div style= "width: 460px; height= 300px; float: right">
![**Figure 6: Webpage displaying metadata.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure6LaPineGageComparisonBlank.JPG", package = "NWCEd"))` ) 
</div>
...
![**Figure 7: Statistic group tables. link.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure7StatisticGroups.JPG", package = "NWCEd"))` )
...
![**Figure 8: Seven Fundamental Daily Streamflow Statistics results. link.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure8StatsResults.JPG", package = "NWCEd"))` )
...
<div style="text-align:justify; clear: left">
![**Figure 9: Changing file types in Excel to "All Files".**]( `r I(system.file("Lab2_NWC-DP_Images/Figure9ExcelImport.JPG", package = "NWCEd"))` )
</div>
<br>
<div style="text-align:justify">
...
<div style= "width: 425px; height= 300px; float: left">
![**Figure 10: Gages-II abstract and metadata link.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure10DelimitedTextWizard.JPG", package = "NWCEd"))` ) 
</div><div style= "width: 425px; height= 300px; float: right">
![**Figure 11: Webpage displaying metadata.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure11DelimiterSetting.JPG", package = "NWCEd"))` ) 
</div>
...
![**Figure 12: Statistics results displayed in Excel.**]( `r I(system.file("Lab2_NWC-DP_Images/Figure12ImportedData.JPG", package = "NWCEd"))` )
